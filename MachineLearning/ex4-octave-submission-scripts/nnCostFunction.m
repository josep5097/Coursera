...
y_2 = zeros(num_labels, m); % 10*5000
for i=1:m,
  y_2(y(i),i)=1;
end

J = (1/m) * sum ( sum ( (-y_2) .* log(h_Theta) - (1-y_2) .* log(1-h_Theta) ));
...
% Regularization
Reg = lambda  * (sum( sum ( Theta_1.^ 2 )) + sum( sum ( Theta_2.^ 2 ))) / (2*m);
...
for t=1:m
  ...
  % Theta2_grad ->(10*1)*(1*26)
	Theta2_grad = Theta2_grad + delta_3 * a2'; 
  % Theta1_grad -> (25*1)*(1*401)
